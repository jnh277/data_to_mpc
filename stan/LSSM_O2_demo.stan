...
model {
    ...
    // state likelihood
    z1[2:N] ~ normal(a11*z1[1:N-1] + a12*z2[1:N-1], q1);
    z2[2:N] ~ normal(a12*z1[1:N-1] + a22*z2[1:N-1] + b2*u[1:N-1], q2) // input affects second state only
